    ...
    public class harmPatches
    {
        ...
        public static void Postfix_BlockEntityAnvil_TryPut(Vintagestory.GameContent.BlockEntityAnvil __instance, IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel, ItemStack ___workItemStack, ref bool __result)
        {
            if (__result)
            {
                ...
                {
                    ___workItemStack.Attributes.SetString("brewername", byPlayer.PlayerName);
                }
            }
        }

        public static void Prefix_BlockEntityStill_TryTake(Vintagestory.GameContent.BlockEntityAnvil __instance, IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel, ItemStack ___workItemStack)
        {
            if (___workItemStack != null)
            {
                ___workItemStack.Attributes.RemoveAttribute("brewername");
            }

        }

        public static void Postfix_GetHeldItemInfo(CollectibleObject __instance,
                                                                                      ItemSlot inSlot,
                                                                                      StringBuilder dsc,
                                                                                      ...
                                                                                      bool withDebugInfo)
        {
            ...
            if (itemstack != null)
            {
                string brewerName = itemstack.Attributes.GetString("brewername");
                
                    string brewDate = itemstack.Attributes.GetString("brewername");
                    dsc.Append(Lang.Get(":smithed_by"));
            }
        }
